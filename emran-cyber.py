...
CYBER-99 = '\x1b[1;102m' # BELAKANG HIJAU
...
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mEMRAN-CYBER
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write('\r     %s[CYBER-99-TEAM] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
